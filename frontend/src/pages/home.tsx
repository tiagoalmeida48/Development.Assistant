...
import { Database, Copy, Code2, Users } from 'lucide-react'
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {features.map((feature) => {
          ...
          return (
            ...
            >
              <div className="border-1 border-border bg-card rounded-xl p-6 hover:shadow-2xl transition-all duration-300 cursor-pointer h-full transform hover:scale-[1.03] hover:-translate-y-1">
