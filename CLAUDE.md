...
- Namespace acompanha a pasta física. Mapping entre camadas via `MapTo<T>()` (round-trip JSON, em `Modules/Common/SerializerExt.cs`) — sem AutoMapper.
